...
/* 
  ...
  Handles user signup using Firebase authentication and cloud storage
*/
const Signup = () => {
  ...
  /*
	...
	Uses Firebase authentication and cloud storage to create user account and store profile picture
  */
